...
public class WebUniStepdefinitions {
    ...
    // ilk sayfa title WebDriverUniversity.com
    // ikinci sayfa title WebDriver | Login Portal

    WebUniPage webUniPage = new WebUniPage();

    @Then("login portal'a kadar asagi iner")
    public void login_portal_a_kadar_asagi_iner() {
        // JavaScriptExecutor ile scrolIntoView
    ...
    public void diger_window_a_gecer() {
        /*
            ...
            - driver.getWindowHandles() ile 2 sayfanin whd'lerini bir set olarak kaydet
            - ilk sayfa whd ==> A , elimizde set var [A,B]
            - o zaman ikinci sayfanin whd = B
